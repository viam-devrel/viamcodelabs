...
1. **Add GitHub repository link**: If you haven't already, set up the GitHub repository where you plan to commit the module source code. Add a link to that GitHub repository as the `url` in the `meta.json` file. This is required for the cloud build to work.
...
1. **Update module**: From the CLI, run `viam module update`, which is required when you make changes to the `meta.json`.
   ...
   viam module update
   ```
1. **Commit and push your updates to GitHub**: Commit and push your latest updates to your remote GitHub repository.
