...
// trailing slash.
const BASE_URL = args.baseUrl || 'https://codelabs.viam.com';
...
// flag.
const CODELABS_BUILD_DIR = args.codelabsDir || 'viamguides/dist';

// CODELABS_SRC_DIR is the directory where the actual codelabs exist on disk.
// Despite being a constant, this can be overridden with the --codelabs-dir
// flag.
const CODELABS_SRC_DIR = args.codelabsSrcDir || 'viamguides/src';
